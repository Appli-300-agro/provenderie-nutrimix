# Provenderie Nutrimix - Plateforme Web E-commerce

Bienvenue sur le dépôt du code source de l'application web **Provenderie Nutrimix**. Ce projet est une solution complète (Site Vitrine + E-commerce + Administration) développée avec des technologies modernes pour assurer performance et évolutivité.
...
| :--- | :--- | :--- | :--- |
| **Administrateur** | `admin@provenderienutrimix.cm` | `admin123` | **OTP : 2025** |
| **Utilisateur** | `user@provenderienutrimix.cm` | `user123` | |
...
*   **Contact :** contact@provenderienutrimix.cm
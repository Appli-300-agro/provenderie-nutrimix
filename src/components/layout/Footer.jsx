  ...
  return (
    <footer className="bg-secondary-dark text-slate-300 py-12 no-print">
      <div className="container mx-auto px-4 grid grid-cols-1 md:grid-cols-4 gap-8">
        {/* Brand */}
        <div>
          <h3 className="text-white text-lg font-heading font-bold mb-4">Provenderie Nutrimix</h3>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm">
            ...
            <li>contact@provenderienutrimix.cm</li>
            <li>+237 672 27 75 30</li>
          </ul>
        </div>
        ...
        <div>
          ...
          <div className="flex gap-4">
            <a href="https://www.facebook.com/p/Provenderie-canadienne-100075983713463/" target="_blank" rel="noopener" className="hover:text-primary transition-colors"><Facebook className="w-5 h-5" /></a>
            <a href="https://wa.me/237672277530" target="_blank" rel="noopener" className="hover:text-primary transition-colors"><MessageCircle className="w-5 h-5" /></a>
          </div>
        </div>
      </div>
      <div className="border-t border-slate-700 mt-12 pt-8 text-center text-xs">
        © {new Date().getFullYear()} Provenderie Nutrimix. Tous droits réservés.
      </div>
    </footer>
  );
};
